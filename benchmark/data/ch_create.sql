...
(
    ...
    EventTime DateTime('UTC') NOT NULL,   -- F14: зона в типе, иначе клиент берет зону сервера
    ...
    ClientEventTime DateTime('UTC') NOT NULL,   -- F14: зона в типе, иначе клиент берет зону сервера
    ...
    LocalEventTime DateTime('UTC') NOT NULL,   -- F14: зона в типе, иначе клиент берет зону сервера
